...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e ""
echo -e " [${GREEN}01${NC}]${BLUE} •${NC} SSH WS/OVPN/UDP      $NC[${GREEN}12${NC}]${BLUE} • ${NC}CEK STATUS $NC"
echo -e " [${GREEN}02${NC}]${BLUE} •${NC} VMESS/VLESS $NC         [${GREEN}13${NC}]${BLUE} • ${NC}INFO PORT VPS $NC"
echo -e " [${GREEN}03${NC}]${BLUE} •${NC} TROJAN-WS/GFW $NC       [${GREEN}14${NC}]${BLUE} • ${NC}INFO AUTO VPS $NC"
echo -e " [${GREEN}04${NC}]${BLUE} •${NC} L2TP/PPTP$NC            [${GREEN}15${NC}]${BLUE} • ${NC}REBOOT VPS $NC"
echo -e " [${GREEN}05${NC}]${BLUE} •${NC} MONITOR BANWIDTH $NC    [${GREEN}16${NC}]${BLUE} • ${NC}CEKS SPEDD $NC"
echo -e " [${GREEN}06${NC}]${BLUE} •${NC} RESTART ALL SERVICE$NC  [${GREEN}17${NC}]${BLUE} • ${NC}CHANGE BANNER $NC"
echo -e " [${GREEN}07${NC}]${BLUE} •${NC} ADD SUBDOMAIN VPS $NC   [${GREEN}18${NC}]${BLUE} • ${NC}RESTART BANNER $NC"
echo -e " [${GREEN}08${NC}]${BLUE} •${NC} RENEW CERTY2RAY $NC     [${GREEN}19${NC}]${BLUE} • ${NC}SETING AUTO BOOT $NC"
echo -e " [${GREEN}09${NC}]${BLUE} •${NC} CLEAR LOG   $NC         [${GREEN}20${NC}]${BLUE} • ${NC}UPDATE MENU $NC"
echo -e " [${GREEN}10${NC}]${BLUE} •${NC} CLEAR CACHE $NC         [${GREEN}21${NC}]${BLUE} • ${NC}INSTALL UDP$NC"
echo -e " [${GREEN}11${NC}]${BLUE} •${NC} TENDANG USER MULTI  $NC [${GREEN}22${NC}]${BLUE} • ${NC}EXIT $NC"
echo -e " ${BLUE}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
read -p "Pilih Angkanya Sayank : " menu
case $menu in
1)
clear
ssh
